...
export const drawingSurfaces = {
    canvas(config) {
        ...
        return {
            ...
            // async downloadPNG() {
            //     const random_id=this.makeid(20);
            //     const out = await fs.createWriteStream(path.resolve(__dirname,`../data/output_${random_id}.png`));
            //     const stream = await el.createPNGStream(); // returns a ReadableStream that emits a PDF
