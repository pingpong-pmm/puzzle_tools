...
//ignore ts
export function Thermo(props, { setImage }) {
    ...
    const [data, setData] = useState(props.temps)
    const ref = useRef();
    ...
    // useEffect(() => {
        ...
        // function doThis() {
        //     const tempss = props.temps?.map((jin, index) => ({
        //         id: index + 1,
        //         temp: jin
        //     }));
        //     setData(tempss)
    ...
    return (
        <div id='view' className='max-w-xl w-full mx-auto'>
            <div ref={ref} className='grid grid-cols-4 bg-gray-50 gap-4 px-5 py-10'>
                {data?.map((item, index) => (
                    <div key={index} className='grid gap-5 items-center'>
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 flex items-end justify-center">
                                <div className="h-[52px] ring-1 ring-black w-[52px] rounded-full bg-black"></div>
                            </div>
                        </div>
...
export class Thermoc {
    ...
    thermo = (
        <Thermo show={false} setImage={(i) => viewImage(i)} />
    )
}